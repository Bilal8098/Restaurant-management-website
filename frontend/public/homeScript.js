...
const apiService = {
  fetchMenuItems: async () => {
    try {
      const response = await fetch('http://ample-miracle-production.up.railway.app/get_menu_items');
  ...
  fetchFeedbacks: async () => {
    try {
      const response = await fetch('http://ample-miracle-production.up.railway.app/get_feedbacks');
      return await response.json();
    } catch (error) {
  ...
  submitFeedback: async (userId, feedbackText) => {
    try {
      ...
      const response = await fetch('http://ample-miracle-production.up.railway.app/add_feedback', {
        method: 'POST',
        headers: {
